/*
  ...
  - You are about to drop the column `sessioonId` on the `Vote` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "Vote_sessioonId_pollId_key";

-- AlterTable
ALTER TABLE "Vote" DROP COLUMN "sessioonId",
